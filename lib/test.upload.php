...
$my_upload->upload_dir = "../../upload/"; // "files" is the folder for the uploaded files (you have to create this folder)
$my_upload->extensions = array(".png", ".zip", ".pdf", ".doc", ".txt", ".html"); // specify the allowed extensions here
